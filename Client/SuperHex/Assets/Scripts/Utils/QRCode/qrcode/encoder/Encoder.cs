	...
	public sealed class Encoder
	{
		...
		internal static void  interleaveWithECBytes(BitVector bits, int numTotalBytes, int numDataBytes, int numRSBlocks, BitVector result)
		{
			...
			for (int i = 0; i < numRSBlocks; ++i)
			{
                ...
                com.google.zxing.common.ByteArray dataBytes = new com.google.zxing.common.ByteArray();
				dataBytes.set_Renamed(bits.Array, dataBytesOffset, numDataBytesInBlock[0]);
                com.google.zxing.common.ByteArray ecBytes = generateECBytes(dataBytes, numEcBytesInBlock[0]);
			...
			for (int i = 0; i < maxNumDataBytes; ++i)
			{
				...
				{
                    com.google.zxing.common.ByteArray dataBytes = ((BlockPair)blocks[j]).DataBytes;
					if (i < dataBytes.size())
					{
			...
			for (int i = 0; i < maxNumEcBytes; ++i)
			{
				for (int j = 0; j < blocks.Count; ++j)
				{
                    com.google.zxing.common.ByteArray ecBytes = ((BlockPair)blocks[j]).ErrorCorrectionBytes;
					if (i < ecBytes.size())
					{
        ...
        internal static com.google.zxing.common.ByteArray generateECBytes(com.google.zxing.common.ByteArray dataBytes, int numEcBytesInBlock)
		{
            ...
            com.google.zxing.common.ByteArray ecBytes = new com.google.zxing.common.ByteArray(numEcBytesInBlock);
