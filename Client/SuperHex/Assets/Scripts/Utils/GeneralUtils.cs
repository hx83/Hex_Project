...
public static class GeneralUtils
{
    ...
    //    {
    //        case PlayerStatus.OFFLINE:
    //            return "<color=#787878>离线</color>";
    //        case PlayerStatus.ONLINE:
    //            return "在线";
    //        case PlayerStatus.GAMEING:
    //            return "<color=#008D00>无尽游戏中</color>";
    //        case PlayerStatus.GAMEING_CAMP:
    //            return "<color=#008D00>限时游戏中</color>";
    //        case PlayerStatus.Teaming:
    //            return "<color=#008D00>组队中</color>";
    //        case PlayerStatus.TeamInv:
    //            return "<color=#008D00>邀请中</color>";
    //        case PlayerStatus.Playing:
    //            return "<color=#008D00>团战游戏中</color>";
    //        default:
    //            return "未知";
    //    }
    //}
